...
{
    //the tank will stop moving towards the player once it reaches this ditance
    public float m_CloseDistance = 8f;
    //The tank's turret object
    public Transform m_Turret;

    //A reference to the player - this will be set when the neemy is loaded
    ...
    void Update() 
    {
        ...
        //if diatnce is less than stop distance, then stop moving
